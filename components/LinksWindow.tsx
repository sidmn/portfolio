      ...
      {isOpen && (
        ...
        >
          <div className="z-1 flex flex-col rounded-xl w-[300px] xl:w-[400px] ">
            ...
            <div className="flex flex-col border-2 bg-white border-[#999999] shadow-xl rounded-b-xl px-5 py-5 gap-2 text-[#4c4c4c]">
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="flex gap-5 text-2xl font-semibold border border-[#e4e4e4] p-2 rounded-lg items-center "
              >
                <Image
                  src="/linkedin.png"
                  width={30}
